		...
		<div class="main ">
			...
			<div class="row">
					...
					<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/QueryPartKeeperServlet"  method="POST"  >
			...
			<div class="row"  >
					<div class="panel panel-default">
								...
								<tbody>
									<c:forEach items="${data}" var="u">
										<tr>
											...
											<td>${u.part_status}</td>
											<td>
												<a href="/DeviceFixingManaging/Keeper/RuKu.jsp?part_no=${u.part_no}">
							...
							<form action="/DeviceFixingManaging/servlet/QueryPartKeeperServlet" method="post">
