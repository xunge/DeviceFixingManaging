...
<body>
	...
	<div class="container-fluid content">
				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DeviceFixingManaging/index/TaskIndex.jsp"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li >
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/QueryRepairRecordTaskServlet"  method="POST"  >
							...
							<tbody>
								<c:forEach items="${data}" var="u">
									<tr>
										...
										<td>
											<a href="/DeviceFixingManaging/Task/UpdateRepairRecord.jsp?repair_record_no=${u.repair_record_no}">
		...
		<!-- end: Content -->
		<br><br><br>
		<form action="/DeviceFixingManaging/servlet/QueryRepairRecordTaskServlet" method="post">
