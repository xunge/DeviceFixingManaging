		...
		<div class="main ">
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/QueryRepairRecordServiceManServlet"  method="POST"  >
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
									...
									<tbody>
										<c:forEach items="${data}" var="u">
											<tr>
												...
												<td>
													<a href="/DeviceFixingManaging/Engineer/UpdateRepairRecord.jsp?repair_record_no=${u.repair_record_no}">
								...
								<form action="/DeviceFixingManaging/servlet/QueryRepairRecordServiceManServlet" method="post">
