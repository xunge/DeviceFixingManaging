				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DeviceFixingManaging/index/EngineerIndex.jsp"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li class="opened">
								<a href="#"><i class="fa fa-file-text"></i><span class="text"> 任务管理</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="/DeviceFixingManaging/Engineer/QueryRepairRecord.jsp"><i class="fa fa-car"></i><span class="text"> 查询任务</span></a></li>
									<li><a href="/DeviceFixingManaging/Engineer/UpdateRepairRecord.jsp"><i class="fa fa-envelope"></i><span class="text"> 跟进任务</span></a></li>
								</ul>	
							</li>
							<li>
								<a href="#"><i class="fa fa-list-alt"></i><span class="text"> 备件申报</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="/DeviceFixingManaging/Engineer/QueryPart.jsp"><i class="fa fa-indent"></i><span class="text"> 查询备件</span></a></li>
									<li><a href="/DeviceFixingManaging/Engineer/AddPartDetail.jsp"><i class="fa fa-tags"></i><span class="text"> 申请备件</span></a></li>
								</ul>
							</li>
		...
		<div class="main ">
			...
			<div class="row">
					...
					<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/QueryPartServiceManServlet"  method="POST"  >
					...
					<div class="panel panel-default">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
							...
							<tbody>
									...
									<tr>
										...
										<td>
											<div class="form-actions">
												<a href="/DeviceFixingManaging/Engineer/AddPartDetail.jsp?part_no=${u.part_no}">
													<button type="submit" class="btn btn-primary">申请备件</button>
												</a>
												<!-- <a href="/DeviceFixingManaging/Enginner/AddPartDetail.jsp?part_no=${u.part_no}">
													<button type="submit" class="btn btn-primary">申请备件</button>
												</a> -->
											</div>
										</td>
								...
								<form  action="/DeviceFixingManaging/servlet/QueryPartServiceManServlet"  method="POST"  >
