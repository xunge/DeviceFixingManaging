			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
								...
								<form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/BossQueryPriceServlet"  method="POST"  >
									<div class="form-group pull-right" >
										&nbsp;&nbsp;&nbsp;<button class="btn btn-primary">查询</button>
									</div>    							
								</form>
								
								<form action="/DeviceFixingManaging/servlet/BossQueryPriceServlet" method="post">
