				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="/DeviceFixingManaging/index/BossIndex.jsp"><i class="fa fa-laptop"></i><span class="text"> 主页</span></a></li>
							<li><a href="/DeviceFixingManaging/Boss/queryCustomer.jsp"><i class="fa fa-table"></i><span class="text"> 查询客户信息</span></a></li>
							<li><a href="/DeviceFixingManaging/Boss/QueryRepairRecord.jsp"><i class="fa fa-table"></i><span class="text"> 查询维修任务</span></a></li>
							<li><a href="/DeviceFixingManaging/Boss/QueryPart.jsp"><i class="fa fa-table"></i><span class="text"> 查询库存</span></a></li>
							<li><a href="/DeviceFixingManaging/Boss/QueryPrice.jsp"><i class="fa fa-table"></i><span class="text"> 查询结算信息</span></a></li>
						</ul>
					</div>					
				</div>
			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                                                 <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/BossQueryRepairRecordTaskServlet"  method="POST"  >
                        ...
                        <form action="/DeviceFixingManaging/servlet/BossQueryRepairRecordTaskServlet"  method="POST"  >
