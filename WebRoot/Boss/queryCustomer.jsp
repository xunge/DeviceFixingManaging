			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/BossQueryCustomerServlet"  method="POST"  >
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
								...
								<form  action="/DeviceFixingManaging/servlet/BossQueryCustomerServlet"  method="POST"  >
