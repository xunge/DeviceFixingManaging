		...
		<div class="main ">
			...
			<div class="row">
					...
					<div class="panel-body">
                        <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/BossQueryPartKeeperServlet"  method="POST"  >
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<form action="/DeviceFixingManaging/servlet/BossQueryPartKeeperServlet" method="post">
