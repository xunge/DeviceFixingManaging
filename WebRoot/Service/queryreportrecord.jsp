    ...
    <div class="container-fluid content">
      <div class="row"> 
        ...
        <div class="main sidebar-minified" style="min-height: 337px;">
          ...
          <form action="/DeviceFixingManaging/servlet/QueryReportRecordServlet" method="post"  class="form-horizontal ">
          ...
          <form action="/DeviceFixingManaging/servlet/QueryReportRecordServlet" method="post">
