			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/QueryCustomerServlet"  method="POST"  >
			...
			<div class="row"  >
					<div class="panel panel-default">
							...
							<div class="panel-body" >
									...
									<tbody>
										<c:forEach items="${data}" var="u">
											<tr>
												...
												<td><a href="/DeviceFixingManaging/Service/updateCustomer.jsp?customer_idno=${u.customer_idno}"><i class="fa fa-edit">&nbsp;</i></a></td>
												<td><a href="/DeviceFixingManaging/servlet/DeleteCustomerServlet?customer_idno=${u.customer_idno}&flag=query">×</a></td>
											</tr>
										</c:forEach>
								...
								<form  action="/DeviceFixingManaging/servlet/QueryCustomerServlet"  method="POST"  >
