			...
			<div class="row">
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form"  action="/DeviceFixingManaging/servlet/AddCustomerServlet"  method="POST"  >
								...
								<table class="table table-bordered table-striped table-condensed table-hover">
									...
									<tbody>
											<tr>
												...
												<td><a href="/DeviceFixingManaging/servlet/DeleteCustomerServlet?customer_idno=${id}">×</a></td>
											</tr>
